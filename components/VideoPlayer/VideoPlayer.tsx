  ...
  const handleSpeedChange = (newSpeed: number) => {
    ...
    return (
      <Card ref={wrapperRef} fullWidth shadow="none" className="group/player -space-y-1 border-2 border-primary-100 rounded-3xl">
        ...
        >
          <div className="w-full h-full aspect-[1920/1080] relative overflow-hidden rounded-t-xl bg-primary">
            <ReactPlayer
              ref={playerRef}
              url={src}
              alt={alt}
        ...
        <CardFooter className="bg-foreground rounded-t-2xl py-2 px-3 shrink-0 z-[1]">
          <div className="w-full flex flex-col gap-2.5 items-center">
            <div className="flex flex-row gap-8 items-center">
              ...
              <Button
                ...
                color="primary"
                variant="solid"
                className="rounded-xl h-10 w-10 p-1.5 lg:rounded-2xl lg:h-12 lg:w-12 lg:p-0"
                onPress={togglePlaying}
              >
                {playing && (
                  <Icon icon="solar:pause-circle-bold-duotone" width="32" height="32" />
                )}
                {!playing && (
                  <Icon icon="solar:play-circle-bold-duotone" width="32" height="32" />
                )}
              </Button>
              <Button
                size="sm"
            ...
            <div className="w-full px-2 lg:px-5 py-0 lg:py-1 flex justify-between flex-wrap gap-1 lg:gap-3 items-center">
              {(variant === "default" || !playing) && (
                <div className={clsx("flex flex-row gap-2 items-center flex-1 truncate min-w-full lg:min-w-0 h-7", variant === "default" ? "justify-center" : "justify-start")}>
                  <h6 className="text-xs lg:text-sm font-normal text-center text-white max-w-full truncate">
                    {title} 
                  </h6>
                </div>
              )}
              ...
              {(variant === "default" || playing) && (
                <div className="flex flex-row gap-0 items-center text-white text-xs font-light">
