...
import { OlympiadRegistrationStepCard } from "@/components/Cards/OlympiadRegistrationStepCard/OlympiadRegistrationStepCard";
import { Icon } from "@iconify/react";
import { useRef } from "react";
import type { Swiper as SwiperType } from 'swiper';

interface OlympiadRegistrationStep {
  id: number;
  stepTitle: string;
  title: string;
  description: string;
...
interface OlympiadRegistrationStepsSectionProps {
  steps: OlympiadRegistrationStep[];
  showNavigation?: boolean;
}

export const OlympiadRegistrationStepsSection: React.FC<OlympiadRegistrationStepsSectionProps> = ({
  steps,
