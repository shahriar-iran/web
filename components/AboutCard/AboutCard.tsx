...
export const AboutCard: React.FC<AboutCardPropsType> = (props) => {
    ...
    return (
        <div className="relative group/about m-2.5 w-full h-fit before:rounded-3xl before:absolute before:bg-primary-100 before:w-[calc(100%-20px)] before:h-full before:z-0 before:-rotate-3">   
            <Card className="relative rounded-3xl w-[calc(100%-20px)]" radius="none" shadow="none" >
