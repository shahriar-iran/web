...
export const Footer: React.FC<FooterPropsType> = () => {
    ...
    return (
        <footer className="flex flex-col gap-0 overflow-hidden">
            ...
            <div className="bg-white px-4 xl:px-0 pb-6 md:pb-10 pt-6">
                <div className="flex flex-col md:flex-row gap-3 justify-between items-center mx-auto w-full max-w-7xl">
                    <FooterCopyright/>
                    <FooterSocial/>
                </div>
            </div>
